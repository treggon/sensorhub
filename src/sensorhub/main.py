...
from sensorhub.adapters.livox_mid360.livox_contour_adapter import router as livox_contour_router
...
# NEW: include contour router (ADDED)
app.include_router(livox_contour_router)
