...
class UbloxGPSAdapter(AbstractSensorAdapter):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"sensorhub.adapters.ublox.{self.__class__.__name__}.{sensor_id}")
        ...
        self._fix_type_str: Optional[str] = None  # human-friendly (derived from fix_quality / UBX)
    ...
    def _frame_from_nmea_line(self, s: str) -> Optional[Dict[str, Any]]:
        ...
        if msg == "GGA" and len(parts) >= 10:
            # ✅ FIXED INDICES: use 6,7,8 for quality/sats/hdop (previously mis-indexed)
